...
public class TodoItemRealmProxy extends com.acme.realmudi.model.TodoItem
    ...
    static final class TodoItemColumnInfo extends ColumnInfo
        ...
        TodoItemColumnInfo(String path, Table table) {
            ...
            this.selectedIndex = getValidColumnIndex(path, table, "TodoItem", "selected");
            indicesMap.put("selected", this.selectedIndex);
        ...
        public final void copyColumnInfoFrom(ColumnInfo other) {
            ...
            this.selectedIndex = otherInfo.selectedIndex;
    ...
    public static RealmObjectSchema createRealmObjectSchema(RealmSchema realmSchema) {
        if (!realmSchema.contains("TodoItem")) {
            ...
            realmObjectSchema.add(new Property("selected", RealmFieldType.BOOLEAN, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED));
    ...
    public static Table initTable(SharedRealm sharedRealm) {
        if (!sharedRealm.hasTable("class_TodoItem")) {
            ...
            table.addColumn(RealmFieldType.BOOLEAN, "selected", Table.NOT_NULLABLE);
    ...
    public static TodoItemColumnInfo validateTable(SharedRealm sharedRealm, boolean allowExtraColumns) {
        if (sharedRealm.hasTable("class_TodoItem")) {
            ...
            if (!columnTypes.containsKey("id")) {
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Missing field 'id' in existing Realm file. Either remove field or migrate using io.store.internal.Table.addColumn().");
            }
            ...
            if (!table.hasSearchIndex(table.getColumnIndex("id"))) {
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Index not defined for field 'id' in existing Realm file. Either set @Index or migrate using io.store.internal.Table.removeSearchIndex().");
            }
            if (!columnTypes.containsKey("createdDate")) {
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Missing field 'createdDate' in existing Realm file. Either remove field or migrate using io.store.internal.Table.addColumn().");
            }
            ...
            if (!columnTypes.containsKey("text")) {
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Missing field 'text' in existing Realm file. Either remove field or migrate using io.store.internal.Table.addColumn().");
            }
            ...
            if (!columnTypes.containsKey("selected")) {
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Missing field 'selected' in existing Realm file. Either remove field or migrate using io.store.internal.Table.addColumn().");
            }
            if (columnTypes.get("selected") != RealmFieldType.BOOLEAN) {
            ...
            if (table.isColumnNullable(columnInfo.selectedIndex)) {
    ...
    public static com.acme.realmudi.model.TodoItem createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (json.has("selected")) {
            if (json.isNull("selected")) {
                ...
                ((TodoItemRealmProxyInterface) obj).realmSet$selected((boolean) json.getBoolean("selected"));
            }
        }
        return obj;
    }
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("id")) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    ((TodoItemRealmProxyInterface) obj).realmSet$selected((boolean) reader.nextBoolean());
                }
            } else {
                reader.skipValue();
            }
    ...
    public static com.acme.realmudi.model.TodoItem copy(Realm realm, com.acme.realmudi.model.TodoItem newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            ...
            ((TodoItemRealmProxyInterface) realmObject).realmSet$selected(((TodoItemRealmProxyInterface) newObject).realmGet$selected());
            return realmObject;
        }
    }
    ...
    public static long insert(Realm realm, com.acme.realmudi.model.TodoItem object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.selectedIndex, rowIndex, ((TodoItemRealmProxyInterface)object).realmGet$selected(), false);
        return rowIndex;
    }
    ...
    public static com.acme.realmudi.model.TodoItem createDetachedCopy(com.acme.realmudi.model.TodoItem realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        ((TodoItemRealmProxyInterface) unmanagedObject).realmSet$selected(((TodoItemRealmProxyInterface) realmObject).realmGet$selected());
